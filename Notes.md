...
- Create a Python 3.12 venv and set `PYTHON` to the location of the Python executable. If building multiple versions in succession, create a fresh new venv with 3.13.0, 3.13.1, 3.13.3, 3.13.6, 3.13.10, and 3.13.12. Otherwise, the venv can be reused.
...
- Create a Python 3.13 venv and set `PYTHON` to the location of the Python executable. If building multiple versions in succession, create a fresh new venv with 3.14.0, 3.14.1, and 3.14.3. Otherwise, the venv can be reused.
